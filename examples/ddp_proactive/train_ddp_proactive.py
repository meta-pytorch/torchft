    ...
    while True:
        for i, (inputs, labels) in enumerate(trainloader):
            ...
            if manager.current_step() == 3:
                ...
                print("Starting Hanging Allreduce")

            test_tensor = torch.tensor([1.0]).to(device)
            print("manager.current_step()", manager.current_step(), "world_size", manager._participating_replica_world_size, "rank", manager._participating_replica_rank)
